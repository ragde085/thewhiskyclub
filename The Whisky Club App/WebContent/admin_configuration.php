...
echo "
			<form class='form' role='form' name='adminConfiguration' action='". $_SERVER ['PHP_SELF'] . "' method='post'>
				<div class='form-group'>
					<label for='webName'>Website Name:</label>
					<input type='text' class='form-control' id='webName' name='settings[".$settings['website_name']['id']."]' value='".$websiteName."' />
				</div>
				<div class='form-group'>
					<label for='webUrl'>Website URL:</label>
					<input type='text' class='form-control' id='webUrl' name='settings[".$settings['website_url']['id']."]' value='".$websiteUrl."' />
				</div>
				<div class='form-group'>
					<label for='email'>Email:</label>
					<input type='text' class='form-control' id='email' name='settings[".$settings['email']['id']."]' value='".$emailAddress."' />
				</div>
				<div class='form-group'>
					<label for='threshold'>Activation Threshold:</label>
					<input type='text' class='form-control' id='threshold'name='settings[".$settings['resend_activation_threshold']['id']."]' value='".$resend_activation_threshold."' />
				</div>
				<div class='form-group'>
					<label for='language'>Language:</label>
					<select class='form-control' id='languaje' name='settings[".$settings['language']['id']."]'>";
...
echo "
				...
				<div class='form-group'>
					<label for='activationEmail'>Email Activation:</label>
					<select class='form-control' id='activationEmail' name='settings[".$settings['activation']['id']."]'>";
...
echo "
				...
				<div class='form-group'>
					...
					<select class='form-control' id='template' name='settings[".$settings['template']['id']."]'>";
