...
echo "
			<form class='form' role='form' name='updateAccount' action='". $_SERVER ['PHP_SELF'] . "' method='post'>
				...
				<div class='form-group'>
					<label for='passwordc' >New Pass</label>
					<input type='password' class='form-control' id='passwordc' name='passwordc' required/>
				</div>
				<div class='form-group'>
					<label for='passwordcheck' >Confirm Pass</label>
